...
{ 
    ...
    IEnumerator PutPiece(Piece.Owner owner)
    {
        ...
        if (HandDeck != null) { 
            ...
            GameManager.Instance.handManager.OnCardSelected(HandDeck.FirstOrDefault());
    ...
    IEnumerator PutPieceAndOnlyAttack(Piece.Owner owner)
    {
        ...
        if (HandDeck != null)
        {
            ...
            GameManager.Instance.handManager.OnCardSelected(HandDeck.FirstOrDefault(card => card.pieceCost == HandDeck.Min(c => c.pieceCost)));
            yield return new WaitForSeconds(2);
        }
